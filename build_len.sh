...
LD_LIBRARY_PATH=$lib_path $root/lib/ld-linux-aarch64.so.1 $root/usr/bin/aarch64-linux-gnu-ld stringlen.o stringlen_1.o stringlen_2.o stringlen_3.o stringlen_4.o stringlen_5.o stringlen_6.o hello_len.o libc/strlen_generic.o libc/strlen_asimd.o -o hello_len
